...
import { getAllTenantSlice } from "../properties/getAllTenantSlice";
import { getPropInfoSlice } from "./getPropInfoSlice";
...
export * from '../properties/getPropInfoSlice';
...
export const PropertiesReducer = combineReducers({
    ...
    getInfo: getPropInfoSlice.reducer,
